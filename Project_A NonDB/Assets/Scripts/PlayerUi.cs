...
public class PlayerUi : MonoBehaviour
{
    ...
    {
        m_imgPlayerHpBar.fillAmount = (float)m_PlayerStatus.CurHp / (float)m_ApplyStatus.MaxHp;
        m_imgPlayerMpBar.fillAmount = (float)m_PlayerStatus.CurSp / (float)m_ApplyStatus.MaxSp;
    }
